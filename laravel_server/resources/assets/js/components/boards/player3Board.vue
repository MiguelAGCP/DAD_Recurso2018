            ...
            <div class="container">
                <!-- <div class="row"> -->
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align:center">
                            <!-- <img v-for="i in 10" v-bind:src="cardImageURL('semFace')" class="myHand"> -->
                             <div v-if="game.gameStarted"><img v-for="card of game.players[1].hand" v-bind:src="cardImageURL(card.imageToShow)" class="myHand"></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-md-offset-3">
                            <!-- <img v-for="i in 10" v-bind:src="cardImageURL('semFace')" class="oponentsHand"> -->
                             <div v-if="game.gameStarted"><img v-for="card of game.players[3].hand" v-bind:src="cardImageURL(card.imageToShow)" class="oponentsHand"></div>
                        </div>
                        <!-- CENTER ZONE -->
                        <div class="col-md-4">
                            <!-- TEAMMATE CARD -->
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align:center">
                            <!-- <img v-for="i in 10" v-bind:src="cardImageURL('semFace')" class="myHand"> -->
                             <div v-if="game.gameStarted"><img v-for="card of game.players[2].hand" v-bind:src="cardImageURL(card.image)" class="myHand"></div>
                        </div>
                    </div>
